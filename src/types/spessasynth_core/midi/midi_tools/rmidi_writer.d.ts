 ...
 */
export function writeRMIDI(this: BasicMIDI, soundfontBinary: Uint8Array, soundfont: BasicSoundBank, bankOffset?: number, encoding?: string, metadata?: RMIDMetadata, correctBankOffset?: boolean): IndexedByteArray;
